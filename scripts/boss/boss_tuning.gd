...
const PHASE_ONE_SPREAD_WEIGHT := 1.0
...
const PHASE_TWO_SPREAD_WEIGHT := 0.85
const PHASE_TWO_SWEEP_COUNT := 4
const PHASE_TWO_SWEEP_ANGLE := 0.18
const PHASE_TWO_SWEEP_WARNING := 0.36
const PHASE_TWO_SWEEP_SPEED_SCALE := 1.32
const PHASE_TWO_SWEEP_BURSTS := 2
const PHASE_TWO_SWEEP_BURST_DELAY := 0.22
const PHASE_TWO_SWEEP_BURST_OFFSET := 0.09
const PHASE_TWO_SWEEP_WEIGHT := 1.15
...
const PHASE_THREE_SPREAD_WEIGHT := 0.9
const PHASE_THREE_SWEEP_COUNT := 4
const PHASE_THREE_SWEEP_ANGLE := 0.18
const PHASE_THREE_SWEEP_WARNING := 0.36
const PHASE_THREE_SWEEP_SPEED_SCALE := 1.34
const PHASE_THREE_SWEEP_BURSTS := 2
const PHASE_THREE_SWEEP_BURST_DELAY := 0.2
const PHASE_THREE_SWEEP_BURST_OFFSET := 0.11
const PHASE_THREE_SWEEP_WEIGHT := 1.25
...
const PHASE_THREE_DELAYED_WEIGHT := 0.95
const PHASE_THREE_DASH_DISTANCE := 82.0
const PHASE_THREE_DASH_WARNING := 0.68
const PHASE_THREE_DASH_WEIGHT := 0.75
